// DDMPADS - Example Site
// Gerado em: 2025-11-25T23:15:00.237Z
// Rewarded Ads: ATIVADO
// Modais: 3 disponíveis

(function(){'use strict';
const CONFIG={"g":"987654321","p":"example","dp":"2.00","pk":"ddmp_price","fn":"example-site.js","sn":"Example Site","refresh":{"enabled":true,"delay":30,"interval":30,"maxCount":1},"rw":true};
const AD_UNITS={"d":{"t":["content","top"],"s":["all","oi"],"c":["all"],"v":[""],"p":["*"],"sz":[[[300,250],[336,280]]],"di":["div-content","div-top"],"pr":[]},"m":[[1,1,0,0,0,1,0,1]],"k":[[0,0,0,0,0,1,0,0]],"mk":{"oi|all|top":[0]},"kk":{"all|all|content":[0]}};
const PRICE_RULES={"tree":{},"flat":{}};
const FALLBACK_MODAL=null;
const CUSTOM_MODALS=[{"id":"cmida6gk00003bh1dj7xu1zxh","slug":"nome-teste","fileUrl":"https://ddmpads-cdn.pages.dev/example-site/modals/modal-example-site-nome-teste.js"},{"id":"cmidaq2xw0005bh1djfpnihkc","slug":"testeeeee","fileUrl":"https://ddmpads-cdn.pages.dev/example-site/modals/modal-example-site-testeeeee.js"},{"id":"cmif6nt5z0001wl7co352izvb","slug":"escolha-seu-estilo-de-roupa","fileUrl":"https://ddmpads-cdn.pages.dev/example-site/modals/modal-example-site-escolha-seu-estilo-de-roupa.js"}];
const MODAL_RULES=[];
...
class ModalLoader {
  ...
  load(slug, callback, timeout = 10000) {
    ...
    const url = "https://ddmpads-cdn.pages.dev/example-site/modals/modal-example-site-" + slug + ".js";
