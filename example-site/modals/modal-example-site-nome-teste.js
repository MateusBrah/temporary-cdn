(function(){'use strict';
const modalConfig={"id":"cmida6gk00003bh1dj7xu1zxh","slug":"nome-teste","title":"Titulo principal","subtitle":"subtitulo principal","mode":"steps","steps":[{"type":"choice","title":"Titulo step 1","options":[{"label":"teste","value":"1"},{"badge":"easy","label":"teste2","value":"2"}],"subtitle":"subtitulo step 1"},{"type":"loader","title":"titulo loader step 2","loaderText":"texto do loader"},{"type":"cta","title":"TITULO CTA","ctaText":"BOTAO TEXTO","description":"DESCRICAO CTA"}],"theme":{"card":{"background":"#142841"},"buttons":{"color":"#fff","background":"#007bff"},"primaryColor":"#007bff","activeStepColor":"#e3f2fd"},"templates":{"choice_0":"<div class=\"step-choice\"><div class=\"ddmp-step-title\">Titulo step 1</div><p class=\"ddmp-step-subtitle\">subtitulo step 1</p><div class=\"ddmp-choices\"><button class=\"ddmp-choice-btn\" data-value=\"1\">teste</button><button class=\"ddmp-choice-btn\" data-value=\"2\">teste2<span class=\"ddmp-badge ddmp-badge-easy\">easy</span></button></div></div>","loader_1":"<div class=\"step-loader\"><div class=\"ddmp-loader\"><div class=\"ddmp-spinner\"></div><p>texto do loader</p></div></div>","final_2":"<div class=\"step-final\"><div class=\"ddmp-step-title\">TITULO CTA</div><p class=\"ddmp-step-desc\">DESCRICAO CTA</p><button class=\"ddmp-btn-primary\">BOTAO TEXTO</button></div>"},"bodyHtml":"","styles":"/* Container principal do modal */ .ddmp-modal-nome-teste { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.8); z-index: 999999; display: none; align-items: center; justify-content: center; } /* Container interno */ .ddmp-modal-nome-teste .ddmp-modal-container { background: #142841; border-radius: 12px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.3); } /* Cabeçalho */ .ddmp-modal-nome-teste .ddmp-modal-header { text-align: center; padding: 20px; border-bottom: 1px solid #eee; } .ddmp-modal-nome-teste .ddmp-modal-header h2 { margin: 0; color: #007bff; font-size: 24px; } .ddmp-modal-nome-teste .ddmp-modal-header p { margin: 8px 0 0 0; color: #666; font-size: 14px; } /* Corpo do modal */ .ddmp-modal-nome-teste .ddmp-modal-body { padding: 20px; } /* Imagens nos steps */ .ddmp-modal-nome-teste .ddmp-step-image { text-align: center; margin-bottom: 20px; } .ddmp-modal-nome-teste .ddmp-step-image img { max-width: 100%; max-height: 200px; border-radius: 8px; object-fit: contain; } /* Título e subtítulo do step */ .ddmp-modal-nome-teste .ddmp-step-title { font-size: 20px; font-weight: 600; color: #007bff; margin-bottom: 12px; text-align: center; } .ddmp-modal-nome-teste .ddmp-step-subtitle { font-size: 14px; color: #666; margin-bottom: 16px; text-align: center; } /* Botão primário (CTA) */ .ddmp-modal-nome-teste .ddmp-btn-primary { background: #007bff; color: #fff; border: none; padding: 12px 24px; border-radius: 6px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; } .ddmp-modal-nome-teste .ddmp-btn-primary:hover { opacity: 0.9; } /* Botões de escolha */ .ddmp-modal-nome-teste .ddmp-choice-btn { background: #f5f5f5; border: 2px solid #ddd; padding: 15px 20px; border-radius: 8px; cursor: pointer; font-size: 16px; transition: all 0.3s; text-align: left; position: relative; width: 100%; margin: 5px 0; } .ddmp-modal-nome-teste .ddmp-choice-btn:hover { background: #e9e9e9; border-color: #007bff; } .ddmp-modal-nome-teste .ddmp-choice-btn.selected { background: #e3f2fd; border-color: #007bff; } /* Badges (EASY, MEDIUM, HARD, etc.) */ .ddmp-modal-nome-teste .ddmp-badge { position: absolute; right: 10px; top: 50%; transform: translateY(-50%); padding: 4px 8px; border-radius: 4px; font-size: 12px; font-weight: 600; } .ddmp-modal-nome-teste .ddmp-badge-easy { background: #4caf50; color: #fff; } .ddmp-modal-nome-teste .ddmp-badge-medium { background: #ff9800; color: #fff; } .ddmp-modal-nome-teste .ddmp-badge-hard { background: #f44336; color: #fff; } /* Loader (carregando) */ .ddmp-modal-nome-teste .ddmp-loader { text-align: center; padding: 40px 20px; } .ddmp-modal-nome-teste .ddmp-spinner { border: 4px solid #f3f3f3; border-top: 4px solid #007bff; border-radius: 50%; width: 40px; height: 40px; animation: spin 1s linear infinite; margin: 0 auto 20px; } @keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } } /* CSS Customizado do theme (modo steps) */ /* CSS Customizado adicional (ambos os modos) */"};
...
const modal={
  ...
  createModal:function(){
    ...
    container.className="ddmp-modal-nome-teste";
