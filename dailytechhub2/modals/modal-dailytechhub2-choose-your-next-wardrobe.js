(function(){'use strict';
const modalConfig = {
  id: 'cmig334rv0005ozr5jl020wow',
  slug: 'choose-your-next-wardrobe',
  title: 'Choose your next wardrobe.',
  cards: [{"id":"card1","emoji":"","title":"card1","imageUrl":"https://images.unsplash.com/photo-1551028719-00167b16eac5?w=400&h=500&fit=crop","description":"Comfortable and stylish for everyday use"},{"id":"card2","emoji":"","title":"Formal Elegante","imageUrl":"https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=400&h=500&fit=crop","description":"Comfortable and stylish for everyday use"},{"id":"card3","emoji":"","title":"Esportivo Moderno","imageUrl":"https://images.unsplash.com/photo-1602293589930-45aad59ba3ab?w=400&h=500&fit=crop","description":"Comfortable and stylish for everyday use"},{"id":"card4","emoji":"","title":"Streetwear Urban","imageUrl":"https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=400&h=500&fit=crop","description":"Comfortable and stylish for everyday use"},{"id":"card5","emoji":"","title":"Boho Vintage","imageUrl":"https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=400&h=500&fit=crop","description":"asasasassa"},{"id":"card6","emoji":"","title":"Minimalista Clean","imageUrl":"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400&h=500&fit=crop","description":"Comfortable and stylish for everyday use"}],
  leftAction: 'It’s not my style.',
  rightAction: 'I loved it, I want this one!',
  minSwipes: 4
};
...
const SwipeModal = {
  ...
  init: function() {
    ...
    style.textContent = ".ddmp-modal-choose-your-next-wardrobe { position: fixed; top: 0; left: 0; width: 100%; height: 100%; Backdrop-filter: Blur(12px); z-index: 999999; display: none; align-items: center; justify-content: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; } .ddmp-modal-choose-your-next-wardrobe * { box-sizing: border-box; } .ddmp-modal-choose-your-next-wardrobe .ddmp-modal-container { max-width: 450px; width: 90%; max-height: 90vh; overflow: hidden; } .ddmp-modal-choose-your-next-wardrobe .ddmp-btn-primary { background: #6366f1; color: #fff; border: none; padding: 16px 40px; border-radius: 30px; cursor: pointer; font-size: 18px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); } .ddmp-modal-choose-your-next-wardrobe .ddmp-btn-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0, 0, 0, 0.3); } .swipe-header{background:linear-gradient(135deg,#ec4899 0%,#8b5cf6 100%);padding:32px 24px;text-align:center;color:white;border-radius:24px 24px 0 0}.swipe-header h1{margin:0 0 24px 0;font-size:28px;font-weight:800;letter-spacing:-0.5px}.swipe-counter{display:flex;justify-content:center;gap:48px;font-size:16px;font-weight:600}.swipe-counter>span{display:flex;align-items:center;gap:8px;background:rgba(255,255,255,0.2);padding:8px 16px;border-radius:50px;backdrop-filter:blur(10px)}.counter-icon{font-size:20px}.counter-value{font-size:18px;min-width:20px;text-align:center}.ddmp-modal-body{padding:24px;background:linear-gradient(to bottom,#fafafa 0%,#ffffff 100%);border-radius:0 0 24px 24px}.swipe-instruction{text-align:center;margin-bottom:16px}.swipe-instruction p{margin:0;font-size:14px;color:#6b7280;font-weight:500}.swipe-stack{position:relative;width:100%;height:440px;margin:0 0 32px 0}.swipe-card{position:absolute;width:100%;height:100%;background:white;border-radius:24px;box-shadow:0 8px 32px rgba(0,0,0,0.12);display:flex;flex-direction:column;overflow:hidden;transition:transform 0.3s cubic-bezier(0.4,0,0.2,1),opacity 0.3s ease;cursor:grab;user-select:none}.swipe-card-image{width:100%;height:70%;object-fit:cover;background:linear-gradient(135deg,#f3f4f6 0%,#e5e7eb 100%)}.swipe-card-content{padding:24px;text-align:center;flex:1;display:flex;flex-direction:column;justify-content:center;background:white}.swipe-card-emoji{font-size:48px;margin-bottom:12px}.swipe-card-title{font-size:22px;font-weight:700;color:#333;margin:0 0 8px 0}.swipe-card-description{font-size:14px;color:#6b7280;margin:0}.swipe-card.swiping{transition:none;cursor:grabbing}.swipe-card.swiped-left{animation:swipe-out-left 0.4s cubic-bezier(0.6,0,0.8,1) forwards}.swipe-card.swiped-right{animation:swipe-out-right 0.4s cubic-bezier(0.6,0,0.8,1) forwards}@keyframes swipe-out-left{to{transform:translateX(-120%) rotate(-20deg);opacity:0}}@keyframes swipe-out-right{to{transform:translateX(120%) rotate(20deg);opacity:0}}";
...
window.DDMPADS_MODALS['choose-your-next-wardrobe'] = SwipeModal;

if (window.DDMPADS_MODAL_LOADED) {
  window.DDMPADS_MODAL_LOADED('choose-your-next-wardrobe');
}
})();