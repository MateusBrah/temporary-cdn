...
// Gerado em: 2025-12-10T15:50:24.455Z
...
const AD_UNITS={"d":{"t":["rewarded","top"],"s":["all"],"c":["al","all"],"v":[""],"p":["*","/doidao"],"sz":[[[300,250],[336,280],[null,null]]],"di":["div-top"],"pr":[]},"m":[[0,0,1,0,0,71],[1,0,1,0,0,5,0,0]],"k":[[0,0,0,0,1,71],[0,0,1,0,0,71]],"mk":{"all|all|rewarded":[0],"all|all|top":[1]},"kk":{"all|all|rewarded":[1]},"kp":{"/doidao":[0]}};
...
class ModalLoader {
  ...
  init() {
    const checkDDMP = () => {
      ...
      const path = window.ddmpAds.path || window.location.pathname.replace(/\/$/,"");
